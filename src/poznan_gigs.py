...
# -*- coding: utf-8 -*-
"""
PromoHunter Bot - Познань Підробіток Парсер
Додано 9 джерел для гнучкої роботи в Познані

НОВА КАТЕГОРІЯ: poznań_gigs (9 источников)
    ...
    return [
        {
            ...
            'description': '🇵🇱 Найбільша дошка оголошень у Польщі. Розділ "Praca dodatkowa" містить сотні aktualних пропозицій щодня: від розносу піци (30-51 zł/godz) до роботи у Biedronka (4150-5500 zł/miesiąc). Фільтри: "umowa zlecenie", "niepełny etat", "praca dodatkowa". Можна шукати за районами Познаня (Jeżyce, Wilda, Grunwald).',
        ...
        },
        {
            ...
            'description': '🇵🇱 Інноваційна платформа для роботи на гodziny. Працює як Uber для праці: завантажуєш додаток, обираєш зміну, працюєш. Швидке z\'єднання pracodawcy з pracownikami за 48h. Категорії: magazyn, gastronomia, event, produkcja. Гнучкий графік, швидко платять.',
        ...
        },
        {
            ...
            'description': '🇵🇱 Група "Praca dorywcza i zlecenia - Poznań i okolice" на Facebook. Члени діляться dorywczymi пропозиціями та zleceniami real-time. Також є група "Praca na część etatu i prace dorywcze" – фокус на непълний час роботи. Прямий контакт з pracodawcami, часто без посередників.',
        ...
        },
        {
            ...
            'description': '🇵🇱 Агенція тимчасової праці. Є спеціальні oferty для "praca dodatkowa". Приклади: pracownik magazynowy w Plewiskach (близько Познаня), umowa na zastępstwo, elastyczne godziny. 39+ офертів для Познаня та Wielkopolski. Часто на контракт (zlecenie) або на заміну.',
